        ...
        return (
          <Form>
            <div className="flex flex-col items-center justify-center h-[100vh] gap-[10px]">
                ...
                <Field name="phone">
                  {({ field }: FieldPhone) => (
                    <MaskedInput
                      ...
                      className="h-[35px] w-[280px] text-[1rem] pl-[10px] pr-[10px] border-none"
                    />
                  )}
                </Field>
                <ErrorMessage
              ...
              <div className="flex flex-col gap-[5px] items-center mt-[10px] mr-[160px]">
                <div className="flex gap-[5px]">
                  ...
                  <Field
                    as="select"
                    name="gender"
                    className="h-[28px] w-[140px] text-[1rem] border-none"
                  >
              ...
              <button
                className="w-[100px] h-[30px] ml-[200px] bg-[#FF8C00] border-none text-[white] cursor-pointer text-[1rem]"
                type="submit"
              >
                Далее
              </button>
